...
#https://github.com/FabienHenon/elm-infinite-list-view/blob/3.2.0/src/InfiniteList.elm
...
Config item msg   = Config (ConfigInternal item msg)


#ConfigInternal item msg :
...
ItemHeight item : [Constant Int,Variable (Int, item -> Int)]


## Creates a new `Model`.

#initModel : Model
#initModel =    { infiniteList = init }
